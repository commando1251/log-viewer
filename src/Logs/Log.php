...
class Log
{
    ...
    /** @var string|LevelInterface The class which defines the severities found on these logs. Should implement the \Commando1251\LogViewer\LogLevels\LevelInterface interface */
